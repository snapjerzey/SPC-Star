...
| `3 pcs / 5,000`, `2 pcs / 5,000 per side`, `1 pc / 8,000` | phase-specific sample/frequency columns | Use columns such as `In Process Required`, `In Process Sample Size`, `In Process Frequency Type`, `In Process Frequency`, and `In Process Frequency Unit`. If the first due count is different from the repeat interval, also use `In Process First Due`. |
